...
class DuelingDQN:
    def __init__(
            ...
            dueling=True,  # Double DQN construction
            double_q=True,
        ...
        self.dueling = dueling  # decide to use dueling or not
        self.double_q = double_q  # decide to use double q or not

        # Just to trigger replacement
        self.learn_step_counter = 0
        self.memory = np.zeros((self.memory_size,
                                state_shape * 2 + 2))  # check what is this - answer(size of state, size of action, size of reward, size of next state)
    ...
    def _build_net(self):
        ...
        def build_layers(s, c_names, n_l1, n_l2, w_initializer, b_initializer):
            ...
            # If you want to use Dueling
            if self.dueling:

                # Calculate a Value of the state
                ...
                # Calculate an Advantages of the state
                ...
                with tf.variable_scope("Q"):
                    # Q = V(s) + A(s,a) -> A(s,a) = A_biased(s,a) - mean(A(s,a))
    ...
    def choose_action(self, observation):
        ...
        actions_value = self.sess.run(self.q_eval, feed_dict={self.s: observation}) # Predict the best action
